...
## Run Information
- Mayhem Run: mayhemheroes/abc/demo/31
- Git Commit: deb6749b92021d5a5942da39436c56112d314a19
- Original Image: ghcr.io/mayhemheroes/abc:master
- Target Executable: /demo
- CI URL: https://github.com:443/mayhemheroes/abc/actions/runs/3524668089
...
- `COPY . /rlenv/source/abc/` happens early (source exists)
...
- ✅ Must work from `/rlenv/source/abc/`

## Critical Requirements Checklist

### Permissions (REQUIRED)
- [ ] Source directory: `chmod -R 777 /rlenv/source`
- [ ] Target executable: `chmod 766 /demo`
...
- [ ] Target executable in Dockerfile.rlenv: `/demo`
- [ ] Target executable in build.sh: `/demo`
- [ ] Target executable in metadata.json: `/demo`
- [ ] All must match for validation to work

### COPY Order (REQUIRED)
- [ ] `COPY . /rlenv/source/abc/` - EARLY (source exists now)
...
- Source copy: `COPY . /rlenv/source/abc/`
...
- Working directory: `cd /rlenv/source/abc/`
- No network access
